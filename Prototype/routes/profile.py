...
def profile_index():
    ...
    return render_template('profile/profile.html.jinja2', posts=posts, number_images_user=number_images_user,
                           number_images_global=number_images_global, images_global_size=images_global_size,
                           images_user_size=images_user_size)
